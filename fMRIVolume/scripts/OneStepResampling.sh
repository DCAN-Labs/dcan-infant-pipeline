...
if [ -e ${WD}/${BiasFieldFile}.${FinalfMRIResolution} ] ; then
...
if [ -e ${WD}/${BiasFieldFile}.${FinalfMRIResolution} ] ; then
    ...
    echo "fslview ${WD}/${T1wImageFile}.${FinalfMRIResolution} ${WD}/${FreeSurferBrainMaskFile}.${FinalfMRIResolution} ${OutputfMRI}" >> $WD/qa.txt
fi
